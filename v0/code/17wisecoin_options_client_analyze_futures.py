...
# 配置文件路径
SYMBOL_PARAMS_FILE = "wisecoin-symbol-params.json" # 保留在根目录
FUTURE_QUOTE_FILE = os.path.join(TEMP_DIR, "wisecoin-期货行情.xlsx")
FUTURE_QUOTE_FILE_NO_OPT = os.path.join(TEMP_DIR, "wisecoin-期货行情-无期权.xlsx")
OPTION_QUOTE_FILE = os.path.join(TEMP_DIR, "wisecoin-期权行情.xlsx")
OPTION_RANKING_FILE = os.path.join(TEMP_DIR, "wisecoin-期权排行.xlsx")
OUTPUT_FILE = os.path.join(TEMP_DIR, "wisecoin-货权联动.xlsx")
...
def analyze_futures_options_correlation():
    ...
    # 加载波动率情绪数据
    OPTION_REFERENCE_FILE = os.path.join(TEMP_DIR, "wisecoin-期权参考.xlsx")
    vol_sentiment_map = {}
...
def merge_analysis_reports():
    ...
    TARGET_FILE = os.path.join(TEMP_DIR, "wisecoin-市场概览.xlsx")

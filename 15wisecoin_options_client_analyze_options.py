...
def generate_option_reference():
    ...
    PARAM_JSON_FILE = "wisecoin-symbol-params.json" # 保留在根目录
    OUTPUT_FILE = os.path.join(TEMP_DIR, "wisecoin-期权参考.xlsx")
...
def analyze_option_changes():
    ...
    FUTURE_QUOTE_FILE = os.path.join(TEMP_DIR, "wisecoin-期货行情.xlsx")
    OUTPUT_FILE = os.path.join(TEMP_DIR, "wisecoin-期权排行.xlsx")
